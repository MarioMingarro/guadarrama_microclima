...
invisible(for (j in 1:length(lat_comp)){
  ...
  for (i in 1:nrow(f_fin)){
    ...
    tmin <-temp$tmin
    tmed <- temp$tmean
    writeRaster(tmax, paste0("B:/MARIPOSAS/TRANSECTOS_MICROCLIMA/MICROCLIMA/2003_2005/TMAX/tmax_", id[j], "_", gsub("/","_", substr(f_inicio[i,], 4,10)),".tif"))
    writeRaster(tmin, paste0("B:/MARIPOSAS/TRANSECTOS_MICROCLIMA/MICROCLIMA/2003_2005/TMIN/tmin_", id[j], "_", gsub("/","_", substr(f_inicio[i,], 4,10)),".tif"))
    writeRaster(tmed, paste0("B:/MARIPOSAS/TRANSECTOS_MICROCLIMA/MICROCLIMA/2003_2005/TMED/tmed_", id[j], "_", gsub("/","_", substr(f_inicio[i,], 4,10)),".tif"))
  }
})
